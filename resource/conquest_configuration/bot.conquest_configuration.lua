...
-- ================================= Standard Settings =========================================
    ...
    oneFlagOffsetTime = 540

	-- Attack Mission Offset Times
    threeFlagOffsetTime = 1600
    fourFlagOffsetTime = 1800

	-- Defense Mission Offset times
    twoFlagOffsetTime = 729
    fiveFlagOffsetTime = 820
	
	neverFlagOffsetTime = 9999
	...
	-- testingDivision = [[/script/multiplayer/bot.data.purchase.conquest.late.6]]
...
-- ================================= Advanded Settings =========================================
	...
	maxNumOfEarlyDivisions = {
		["ger"] = 5,
		["fin"] = 5,
		["rus"] = 5,
	}
	-- maxNumOfMidDivisions = 6
	maxNumOfMidDivisions = {
		["ger"] = 6,
		["fin"] = 6,
		["rus"] = 6,
	}
