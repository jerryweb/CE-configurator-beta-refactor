Purchases["campaign_capture_the_flag"] = {
	{--purchase 1  arty
		...
		Units = {
			...
			--	{priority = 1.0, class = UnitClass.ArtilleryTank, unit = "170mm_minewerfer"},
				{priority = 0.5, class = UnitClass.ArtilleryTank, unit = "203mm_h17ai"},
			--Rocket_Artillery
				{priority = 0.5, class = UnitClass.ArtilleryTank, unit = "150mm_rkh41ai"},
	...
	{--purchase 9 rocket arty
		...
		Units = {
			...
			["fin"] = {--Finland
				{priority = 1.5, class = UnitClass.ArtilleryTank, unit = "150mm_rkh41ai"},
				{priority = 1.5, class = UnitClass.ArtilleryTank, unit = "203mm_h17ai"},
			},
			["rus"] = {--Russia
