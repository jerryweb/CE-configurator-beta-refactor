Purchases["campaign_capture_the_flag"] = {
	{--purchase 1 arty wave
		...
		Units = {
			["ger"] = {--Germany
			--Infantry_Support
				{priority = 0.4, class = UnitClass.ArtilleryTank, unit = "75mm_leig18"},
			--Artillery
				...
				{priority = 0.8, class = UnitClass.ArtilleryTank, unit = "210mm_nebelwerfer42ai"},
				{priority = 0.6, class = UnitClass.ATTank, unit = "210mm_morser18ai"},
			},
			["hun"] = {--Hungary
			--Infantry
			...
			["rus"] = {--Russia
			--Artillery
				{priority = 0.2, class = UnitClass.ArtilleryTank, unit = "76mm_m1927"},
				{priority = 0.2, class = UnitClass.ArtilleryTank, unit = "76mm_m43"},
	...
	{--purchase 10 rocket arty
		...
		Units = {
			...
			--Rocket_Artillery
				{priority = 1.1, class = UnitClass.ArtilleryTank, unit = "150mm_rkh41"},
