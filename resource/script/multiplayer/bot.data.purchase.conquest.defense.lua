Purchases["campaign_capture_the_flag"] = {
	{--all units
		...
		Units = {
			...
			--Wheel_vehicles
				{priority = 0.5, class = UnitClass.Vehicle, unit = "bmw_r71"},
				{priority = 0.5, class = UnitClass.Vehicle, unit = "kfz15"},
				{priority = 0.5, class = UnitClass.Vehicle, unit = "kubelwagen_mg"},
				{priority = 0.1, class = UnitClass.Vehicle, unit = "kubelwagen_dak"},
				{priority = 2.0, class = UnitClass.AATank, unit = "blitz3_6_flak30"},
				{priority = 0.1, class = UnitClass.Vehicle, unit = "p204_f"},
				{priority = 1.5, class = UnitClass.Vehicle, unit = "kfz13"},
			...
			--Half_tracks
				...
				{priority = 0.1, class = UnitClass.ATTank, unit = "sdkfz10_4"},
			...
			--Tanks_medium
				{priority = 0.1, class = UnitClass.Tank, unit = "panzer35s"},
			...
			--Tanks_heavy
				{priority = 0.1, class = UnitClass.HeavyTank, unit = "panzerb2"},
			...
			--Infantry Singles
				...
				{priority = 0.5, class = UnitClass.Infantry, unit = "single_ap_miner(fin)"},
				{priority = 0.5, class = UnitClass.Infantry, unit = "single_at_miner(fin)"},
				{priority = 0.5, class = UnitClass.Infantry, unit = "single_engineer(fin)"},
			...
			--Infantry Squads
				...
				{priority = 0.1, class = UnitClass.Infantry, unit = "squad_heavy_engineer_mid_con(fin)"},
				{priority = 0.5, class = UnitClass.Infantry, unit = "squad_engineer_mid_con(fin)"},
			...
			--Mortars
				...
				{priority = 0.5, class = UnitClass.ArtilleryTank, unit = "170mm_minewerfer"},
			--Infantry_Support
			...
			--Artillery
				{priority = 1.0, class = UnitClass.ArtilleryTank, unit = "105mm_k13"},
				{priority = 1.0, class = UnitClass.ArtilleryTank, unit = "107mm_k10"},
			...
			--Infantry Squads
				...
				{priority = 2.5, class = UnitClass.Infantry, unit = "squad_rifleunit_con(rus)"},
			...
			--Wheel_vehicles
				...
				{priority = 0.1, class = UnitClass.Vehicle, unit = "gaz_aaa_72k"},
				{priority = 0.5, class = UnitClass.Vehicle, unit = "fai_m"},
				{priority = 1.5, class = UnitClass.Vehicle, unit = "ba20"},
				{priority = 2.0, class = UnitClass.Vehicle, unit = "ba6"},
				{priority = 2.0, class = UnitClass.Vehicle, unit = "ba10"},
			...
			--Tanks_light
				...
				{priority = 0.1, class = UnitClass.Vehicle, unit = "t20"},
				{priority = 0.1, class = UnitClass.Vehicle, unit = "t27"},
			...
			--Tanks_medium
				...
				{priority = 1.0, class = UnitClass.Tank, unit = "t28e"},
