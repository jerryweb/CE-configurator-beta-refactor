...
performance = Radiobutton(root, text = "Performance Mode (Easy)", variable = difficulty,value = "performance").grid(row = 5,column = 2)
...
chooseDifficulty = Label(root, text = "Please choose your difficulty first before changing other values!").grid(row = 1,column = 2)
...
periodButton = Button(root, text = "War period", command = openPeriod).grid(row = ,column = 1)
...
#choosDdifficulty =Label(root, text="Choose your difficulty before changing anything").grid(row=1,column=2)
